                    ...
                    >
                        <div className="flex items-center justify-between pb-5 border-b border-stone-100">
                            ...
                            <button
                                type="button"
                                onClick={() => setIsMenuOpen(false)}
                                className="p-2 text-stone-500 hover:text-stone-900 rounded-lg hover:bg-stone-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-800 min-h-[44px] min-w-[44px] flex items-center justify-center"
