    ...
    <main className="relative flex-1 bg-white">
      ...
      <section id="services" className="relative py-24 bg-white overflow-hidden">
        <div className="relative z-10 w-full px-6 md:px-12 max-w-7xl mx-auto">
          ...
          {/* En-tête de section */}
          <FadeIn direction="up" className="mb-14 flex flex-col gap-4">
            ...
            {SERVICES.map((service) => {
              ...
              return (
                <StaggerItem key={service.id}>
                  <Card
                    className="group relative flex flex-col border-stone-200 bg-white transition-all duration-200 hover:border-blue-400 hover:shadow-md hover:-translate-y-1 rounded-2xl shadow-2xs h-full"
                  >
